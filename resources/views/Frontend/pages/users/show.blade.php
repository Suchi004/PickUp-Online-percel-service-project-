...
<div class="container mt-2">
 ...
 <div class="col-md-8">
  <div class="card card-body">
      ...
      <a href="#mapModal" data-toggle="modal">Current Location Of {{$user->first_name}}</a>
    ...
    <h5 class="modal-title" id="exampleModalLongTitle">{{$user->first_name}}'s Location</h5>
  ...
  <div id="map">
        ...
        <script src="http://localhost:4487/backend/socket/socket.io.js"></script>
