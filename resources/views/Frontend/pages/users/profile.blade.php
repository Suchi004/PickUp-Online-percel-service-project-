                        ...
                        <div class="form-group row">
                          ...
                          <div class="form-group row">
                            ...
                            <select class="form-control" name="district_id">
                             ...
                             <div class="form-group row">
                            <label for="shipping_address" class="col-md-4 col-form-label text-md-right">{{ __('Street Address') }}</label>

                            <div class="col-md-6">
                                <input id="street_address"  class="form-control @error('street_address') is-invalid @enderror"type="text" value="{{ $user->street_address }}" name="street_address">
